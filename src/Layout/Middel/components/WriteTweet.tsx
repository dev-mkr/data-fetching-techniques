...
const WriteTweet = () => {
  return (
    <div className="w-full overflow-auto">
      <div className="flex items-center justify-between border-b border-l border-r  border-gray-700 bg-dim-900 px-4 py-3">
        <h2 className="font-sm font-bold text-gray-100">Home</h2>
        <div>
          <svg viewBox="0 0 24 24" className="w-5 text-blue-400" fill="currentColor">
            <g>
      ...
      <div className="border-b border-l border-r  border-dim-200 pb-4">
        <div className="flex flex-shrink-0 p-4 pb-0">
          ...
          <div className="w-full p-2">
            <textarea
              className="h-10 w-full resize-none border-0 bg-transparent  text-white placeholder-gray-400 focus:outline-none"
